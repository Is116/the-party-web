    ...
    <section id="download" className="py-24 relative overflow-hidden">
      ...
      <div className="section-container relative z-10">
        ...
        >
          ...
          >
            <FiSmartphone className="text-6xl text-accent-green mx-auto mb-6" />
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="group flex items-center space-x-4 bg-card px-8 py-5 rounded-2xl border-2 border-text-secondary/20 hover:border-accent-green/50 transition-all duration-300 w-full sm:w-auto"
            >
          ...
          >
            ...
            <div className="card text-center">
              ...
              <div className="text-text-secondary">Artists</div>
            </div>
            <div className="card text-center">
